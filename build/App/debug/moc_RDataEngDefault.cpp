...
QT_MOC_LITERAL(1, 16, 29), // "sigROriginModel_unPackROrigin"
QT_MOC_LITERAL(2, 46, 0), // ""
QT_MOC_LITERAL(3, 47, 8), // "ROrigin*"
QT_MOC_LITERAL(4, 56, 9) // "rrrorigin"

    },
    "RDataEngDefault\0sigROriginModel_unPackROrigin\0"
    "\0ROrigin*\0rrrorigin"
};
...
void RDataEngDefault::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RDataEngDefault *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigROriginModel_unPackROrigin((*reinterpret_cast< ROrigin*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (RDataEngDefault::*)(ROrigin * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RDataEngDefault::sigROriginModel_unPackROrigin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RDataEngDefault::sigROriginModel_unPackROrigin(ROrigin * _t1)
{
