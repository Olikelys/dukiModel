...
QT_MOC_LITERAL(6, 97, 21), // "SlotGetSerialPortName"
QT_MOC_LITERAL(7, 119, 13) // "SlotReadyRead"

    },
    "RLink::RConnectSerialPort\0"
    "sigGetSerialPortName\0\0sigSetSerialPortName\0"
    "serialPortName\0sigReadyRead\0"
    "SlotGetSerialPortName\0SlotReadyRead"
};
...
void RLink::RConnectSerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: { int _r = _t->SlotGetSerialPortName();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 4: { int _r = _t->SlotReadyRead();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
